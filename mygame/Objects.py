...
class Assets:
    def __init__(self):
        ...
        start_image = pygame.image.load("./assets/first_asset.png")
        start_image = pygame.transform.scale(start_image,(750,450))
        space_invaders = pygame.image.load("./assets/space_invaders.png")
        ...
        shuttle_image = pygame.image.load("./assets/shuttle.png")
